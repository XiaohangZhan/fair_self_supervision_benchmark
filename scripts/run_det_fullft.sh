...
outdir="$HOME/data/ssl-benchmark-output/detectron-output-fullft"
...
if $MULTI; then
    python $detectron/tools/train_net.py \
        --multi-gpu-testing \
        --cfg "$fair_ssl_tools/configs/legacy_tasks/object_detection_full_finetune/voc07/fast_rcnn_R-50-C4_with_ss_proposals_trainval.yaml" \
