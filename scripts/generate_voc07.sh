...
cat $VOC/ImageSets/Main/trainval.txt $VOC/ImageSets/Main/test.txt > $VOC/lists/trainvaltest.tmp
awk 'NF{print $0 ".jpg"}' $VOC/lists/trainvaltest.tmp > $VOC/lists/trainvaltest.txt
rm $VOC/lists/trainvaltest.tmp
